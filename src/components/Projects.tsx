...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Zaroori Bazaar",
      description: "A website that enables farmers to conduct intradistrict trading and maintain a digitized portfolio for online sales.",
    ...
    {
      title: "Heritage Hunt",
      description: "A website where travelers document their experiences and others access those accounts for reliable trip insight.",
      tech: ["React", "Tailwind", "Node.js", "AWS"],
